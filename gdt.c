...
gdt_entry_t gdt[GDT_COUNT] = {
    ...
    [GDT_IDX_CODE_0] =
        {
            .limit_15_0 = GDT_LIMIT_LOW(0x000330FF),
            .base_15_0 = GDT_BASE_LOW(0x00000000),
            .base_23_16 = GDT_BASE_MID(0x00000000),
            .type = DESC_TYPE_EXECUTE_READ,
            .s = DESC_CODE_DATA,
            .dpl = 0x00,                                    //privilegios 0
            .p = 0x01,                                      //presente en ram
            .limit_19_16 = GDT_LIMIT_HIGH(0x000330FF),
            .avl = 0x01,                                    //sin uso
            .l = 0x00,                                      //segmentos de 64 -> no. Vamos a usar 32
            .db = 0x01,                                     //segnentos de 32
            .g = 0x01,                                      //granularidad
            .base_31_24 = GDT_BASE_HIGH(0x000000000),
        },
      ...
      [GDT_IDX_CODE_3] =
        {
            ...
            .type = DESC_TYPE_EXECUTE_READ,
            .s = DESC_CODE_DATA,
            .dpl = 0x3,                                     //privilegios 3
            .p = 0x1,                                       //presente en ram
            .limit_19_16 = GDT_LIMIT_HIGH(0x000330FF),
            .avl = 0x01,                                    //sin uso
            .l = 0x00,                                      //segmentos de 64 -> no. Vamos a usar 32
            .db = 0x01,                                     //segnentos de 32
        ...
        [GDT_IDX_VIDEO] =
        {
            .limit_15_0 = GDT_LIMIT_LOW(GDT_LIMIT_BYTES(0x00001F40)),
            ...
            .dpl = 0x0,                                     //privilegios 0
            .p = 0x1,                                       //presente en ram
            .limit_19_16 = GDT_LIMIT_HIGH(GDT_LIMIT_BYTES(0x00001F40)),
            .avl = 0x1,                                     //sin uso
            .l = 0x00,                                      //segmentos de 64 -> no. Vamos a usar 32
            .db = 0x01,                                     //segnentos de 32
            .g = 0x00,                                      //granularidad
...
gdt_descriptor_t GDT_DESC = {sizeof(gdt) - 1, (uint32_t)(&gdt)};
                           //esto  hace de limite , esto de su dir base.
                           //podemos pensarlo como GDTR